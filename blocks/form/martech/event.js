...
export async function getAudiences(xdm, data) {
  ...
  const response = await window.alloy('sendEvent', {
    ...
    xdm,
    decisionScopes: [
      'eyJ4ZG06YWN0aXZpdHlJZCI6ImRwczpvZmZlci1hY3Rpdml0eToxOTcwYjA4MTQzZmI3NzRhIiwieGRtOnBsYWNlbWVudElkIjoiZHBzOm9mZmVyLXBsYWNlbWVudDoxOTU5MzY2YWVlYWM5NzkzIn0=',
